...
class weeklyViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UITableViewDelegate, UITableViewDataSource
{
    ...
    func setCellsView()
    {
        ...
        let hight = (collectionView.frame.size.height - 2) / 2
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.lblDayOfMonth.text = String(CalendarHelper().daysOfMonth(date: date))
    ...
    @IBAction func btnPrevWeek(_ sender: Any)
    {
        selectedDate = CalendarHelper().addDays(date: selectedDate, days: -7)
        SetWeekView()
    }
